...
**Learning Targets** WD-1 practiceactivity4.qmd \# 1 Reading in xlsx file using here and lab 7 #1 reading in csv using here function.
...
R-1 lab 5 is a professional looking quarto document.

R-2 challenge 9  is well documented and tidy code
...
DVS-2 challenge 9 #3 I used a geom_text label to label each bar
